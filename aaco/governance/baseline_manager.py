...
class PerformanceBaseline:
    ...
    name: str
    model_name: str
    version: BaselineVersion = field(default_factory=lambda: BaselineVersion(version="1.0.0", created_at=time.time()))
...
class BaselineManager:
    ...
    def __init__(self, storage_path: Optional[Path] = None):
        ...
        self.baselines: Dict[str, Dict[str, PerformanceBaseline]] = {}  # name -> version -> baseline
    ...
    def get_baseline(self, 
                     name: str, 
                     version: Optional[str] = None) -> Optional[PerformanceBaseline]:
        """
    ...
    def compare(self,
                ...
                significance_threshold_pct: float = 5.0) -> BaselineComparison:
        """
