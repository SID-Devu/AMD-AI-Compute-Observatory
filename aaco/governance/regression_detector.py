...
class RegressionDetector:
    ...
    def _detect_zscore(
        self, result: RegressionResult, baseline: List[float], current: List[float]
    ) -> None:
        """Z-score based detection."""
    ...
    def detect_from_history(
        self, metric_name: str, current_values: List[float]
    ) -> RegressionResult:
    ...
    def batch_detect(
        self, metrics: Dict[str, Tuple[List[float], List[float]]]
