...
class PerfettoTraceLake:
    ...
    def add_instant(self, track_id: int, name: str, timestamp_ns: int,
                    category: str = "", **annotations) -> None:
    ...
    def add_duration(self, track_id: int, name: str, start_ns: int,
                     duration_ns: int, category: str = "",
                     depth: int = 0, **args) -> None:
    ...
    def add_counter(self, track_id: int, name: str, timestamp_ns: int,
                    value: float, category: str = "") -> None:
    ...
    def add_flow_start(self, track_id: int, name: str, timestamp_ns: int,
                       category: str = "") -> int:
    ...
    def add_flow_step(self, track_id: int, name: str, timestamp_ns: int,
                      flow_id: int, category: str = "") -> None:
    ...
    def add_flow_end(self, track_id: int, name: str, timestamp_ns: int,
                     flow_id: int, category: str = "") -> None:
        """End a flow event."""
        event = FlowEvent(
            track_id=track_id,
    ...
    def add_gpu_kernel(self, kernel_name: str, start_ns: int, duration_ns: int,
                       grid: str = "", block: str = "", **metrics) -> None:
