...
class FeatureStoreBuilder:
    ...
    def set_latency_stats(
        self, p50_us: float, p90_us: float, p99_us: float, mean_us: float, std_us: float
    ) -> "FeatureStoreBuilder":
    ...
    def set_quality(
        self, capsule_health: float, noise_score: float, stability: float
    ) -> "FeatureStoreBuilder":
