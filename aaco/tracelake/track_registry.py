...
class TrackRegistry:
    ...
    def register_custom(self, name: str, track_type: TrackType,
                       category: TrackCategory,
                       description: str = "",
                       unit: str = "",
                       color: str = "",
                       parent_track: Optional[str] = None) -> int:
    ...
    def get_gpu_counter_track(self, gpu_id: int, counter_name: str,
                             unit: str = "") -> TrackDefinition:
