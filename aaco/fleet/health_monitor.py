...
class HealthMonitor:
    ...
    def __init__(self, fleet_manager: FleetManager, thresholds: Optional[HealthThresholds] = None):
    ...
    def record_job_result(self, node_id: str, success: bool, latency_ms: float) -> None:
        """
    ...
    def _create_alert(self, node_id: str, severity: AlertSeverity, message: str) -> HealthAlert:
    ...
    def get_fleet_health_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "unacknowledged_alerts": sum(
                1 for a in self._alerts.values() if not a.resolved and not a.acknowledged
            ),
        }
