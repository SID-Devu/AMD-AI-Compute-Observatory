...
class EvidenceChain:
    ...
    def _update_strength(self) -> None:
        ...
        total_weight = sum(weights.get(e.strength, 0.5) for e in self.evidence_list)
...
class EvidenceCollector:
    ...
    def collect_metric(
        self, name: str, value: float, expected: float = 0.0, unit: str = ""
    ) -> Evidence:
    ...
    def get_evidence_for_cause(self, cause_id: str) -> List[Evidence]:
        ...
        return [e for e in self.evidence_store.values() if e.supports_cause == cause_id]
    ...
    def summarize_evidence(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "threshold_exceeded": sum(
                1 for e in self.evidence_store.values() if e.threshold_exceeded
            ),
        }
