...
class CPUTopology:
    ...
    def _discover_numa(self) -> None:
        ...
        if not numa_base.exists():
            ...
            node = NUMANode(node_id=0, cores=list(self.cores.keys()), distance_map={0: 10})
    ...
    def _fallback_discovery(self) -> None:
        ...
        self.numa_nodes[0] = NUMANode(node_id=0, cores=list(range(cpu_count)), distance_map={0: 10})
    ...
    def select_cores(
        self,
        count: int,
        policy: TopologyPolicy = TopologyPolicy.COMPACT,
        numa_node: Optional[int] = None,
        exclude_smt: bool = False,
    ) -> CoreSet:
        """
