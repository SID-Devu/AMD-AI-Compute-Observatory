...
class FingerprintGenerator:
    ...
    FAMILY_PATTERNS = {
        ...
        "reduction": [r"reduce", r"sum", r"mean", r"max", r"min", r"argmax", r"argmin"],
        "embedding": [r"embed", r"lookup", r"gather", r"index_select"],
        "memory": [
            r"copy",
            r"transpose",
            r"permute",
    ...
    def generate(self, signature: KernelSignature) -> KernelFingerprint:
        ...
        hash_input = self._build_hash_input(canonical, config_class, family_id, timing_class)
    ...
    def _compute_config_class(self, sig: KernelSignature) -> str:
        ...
        # Grid dimensionality
        grid_dims = sum([sig.grid_x > 1, sig.grid_y > 1, sig.grid_z > 1])

        # Block dimensionality
        block_dims = sum([sig.block_x > 1, sig.block_y > 1, sig.block_z > 1])
    ...
    def _build_hash_input(
        self, canonical: str, config_class: str, family_id: str, timing_class: str
    ) -> str:
