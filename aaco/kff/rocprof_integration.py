...
class CounterConfig:
    ...
    # Memory counters
    memory_counters: List[str] = field(
    ...
    # Compute counters
    compute_counters: List[str] = field(
        default_factory=lambda: [
    ...
    # Occupancy counters
    occupancy_counters: List[str] = field(
        default_factory=lambda: [
    ...
    def get_all_counters(self) -> List[str]:
        ...
        return self.memory_counters + self.compute_counters + self.occupancy_counters
