...
class DerivedMetricsEngine:
    ...
    def _compute_phase(self, phase: str) -> PhaseMetrics:
        ...
        return PhaseMetrics(
            ...
            cov_pct=float(100 * np.std(latencies) / np.mean(latencies))
    ...
    def _compute_throughput(self) -> Dict[str, float]:
        ...
        return {
            ...
            "mean_latency_ms": sum(r.latency_ms for r in measure_results) / count
            if count > 0
            else 0,
        }
    ...
    def _compute_latency_stats(self) -> Dict[str, float]:
        ...
        if warmup_results and measure_results:
            ...
            warmup_effect = (
                ((warmup_mean - measure_mean) / measure_mean * 100) if measure_mean > 0 else 0
            )
