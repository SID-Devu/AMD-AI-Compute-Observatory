...
class RegressionDetector:
    ...
    def _statistical_test(
        ...
        """
        if (
            len(baseline) < self.thresholds.min_samples
            or len(current) < self.thresholds.min_samples
        ):
    ...
    def _determine_verdict(
        ...
        is_significant = p_value is not None and p_value < self.thresholds.statistical_significance
