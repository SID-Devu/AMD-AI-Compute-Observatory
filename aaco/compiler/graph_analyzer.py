...
class GraphAnalyzer:
    ...
    COMPUTE_HEAVY_OPS = {
        ...
        "MatMulInteger", "QAttention", "Attention",
    }
    
    MEMORY_HEAVY_OPS = {
        "Gather", "Scatter", "GatherElements", "ScatterElements",
        "Concat", "Split", "Slice", "Transpose", "Reshape",
    }
    ...
    KNOWN_PATTERNS = {
        ...
        "layernorm": ["ReduceMean", "Sub", "Pow", "ReduceMean", "Add", "Sqrt", "Div", "Mul", "Add"],
    ...
    def _find_sequence_matches(self, sequence: List[str],
                               pattern: List[str]) -> List[List[int]]:
