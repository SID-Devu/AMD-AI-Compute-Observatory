...
class PerformanceEnvelope:
    ...
    def _init_boundaries(self) -> None:
        ...
        self.boundaries.append(EnvelopeBoundary(
            name="FP32 Roofline",
    ...
    def add_point(self, 
                  ...
                  kernel_name: Optional[str] = None) -> EnvelopePoint:
        """
    ...
    def _generate_recommendations(self, point: EnvelopePoint,
                                  analysis: EnvelopeAnalysis) -> List[str]:
        ...
        if point.efficiency < 0.5:
            recs.append(f"Low efficiency ({point.efficiency*100:.0f}%): Significant optimization opportunity")
        elif point.efficiency > 0.8:
            recs.append(f"High efficiency ({point.efficiency*100:.0f}%): Near optimal for this AI")
