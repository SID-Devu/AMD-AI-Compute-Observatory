...
class GPUModel:
    ...
    def max_occupancy(self, registers_per_thread: int,
                      shared_mem_per_block: int,
                      threads_per_block: int) -> float:
        """
    ...
    def estimate_kernel_time(self,
                            flops: int,
                            bytes_transferred: int,
                            arithmetic_intensity: Optional[float] = None) -> float:
        """
    ...
    def get_optimization_potential(self,
                                   current_efficiency: float,
                                   bottleneck: str) -> Dict[str, Any]:
        """
        ...
        if bottleneck == "memory":
            ...
            potential["suggestions"].extend([
                ...
                "Check MFMA utilization" if self.specs.compute.mfma_available else "Improve vectorization",
            ])
