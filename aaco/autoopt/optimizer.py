...
class AutoOptimizer:
    ...
    def _apply_item(self, item: OptimizationItem, apply_fn: Optional[Callable]) -> bool:
    ...
    def _validate_item(self, item: OptimizationItem, validate_fn: Optional[Callable]) -> bool:
