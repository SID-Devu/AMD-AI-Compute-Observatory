...
class CounterCalibrator:
    ...
    def calibrate(self, 
                  ...
                  counters: Optional[List[str]] = None) -> CalibrationResult:
        """
        ...
        try:
            ...
            self.profile.overhead.launch_overhead_stddev = statistics.stdev(launch_times) if len(launch_times) > 1 else 0.0
            ...
            for counter in counters:
                ...
                self.profile.overhead.counter_overhead_ns[counter] = int(statistics.mean(counter_times))
            ...
            if self.profile.overhead.launch_overhead_stddev > self.profile.overhead.launch_overhead_ns * 0.2:
