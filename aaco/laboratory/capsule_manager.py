...
from .execution_capsule import ExecutionCapsule, CapsuleManifest
...
class CapsuleManager:
    ...
    def find_matching_environment(
        self,
        capsule: ExecutionCapsule
    ) -> Optional[ExecutionCapsule]:
    ...
    def get_environment_history(self) -> List[Dict[str, Any]]:
        ...
        return [
            {'hash': h, **info}
            for h, info in self._index['environments'].items()
        ]
