    ...
    def run_calibration(
        ...
        if envelope.peak_memory_bandwidth_gbps > 0:
            envelope.memory_bandwidth_efficiency = (
                envelope.achieved_memory_bandwidth_gbps / 
                envelope.peak_memory_bandwidth_gbps
            )
        
        if envelope.peak_fp32_tflops > 0:
            envelope.compute_efficiency = (
                envelope.achieved_fp32_tflops / envelope.peak_fp32_tflops
            )
